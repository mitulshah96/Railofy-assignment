...
MovieDetail.getInitialProps = async function (context) {
  ...
  const res = await (await Object(_actions__WEBPACK_IMPORTED_MODULE_1__["getMovieDetail"])({
    id
  })).json();
  return res;
};
...
module.exports = __webpack_require__(/*! /Users/mitulshah/Desktop/Next/pages/detail/[id].js */"./pages/detail/[id].js");
